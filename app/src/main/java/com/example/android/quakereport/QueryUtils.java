...
public final class QueryUtils {
    // TODO: Remove this sample JSON response
    // TODO: Add helper methods to create URL object, perform network request, convert InputStream to a String and parse the JSON
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            // TODO: Modify this parsing logic to parse the response from the server
            JSONObject quakeResultsObject = new JSONObject(SAMPLE_JSON_RESPONSE);
